...
public abstract class AbstractAnimal implements Animal {
  ...
  Integer degreeOfPollution;

  AbstractAnimal(String name, String breed, String character,
                 String cost, String degreeOfPollution) {
    this.name = name;
    this.breed = breed;
  ...
  public boolean equals(Object o) {
    ...
    if (breed != null ? !breed.equals(that.breed) : that.breed != null) {
      return false;
    }
    if (name != null ? !name.equals(that.name) : that.name != null) {
      return false;
    }
    return (character != null ? character.equals(that.character)
        : that.character == null) && (cost != null ? cost.equals(that.cost)
        : that.cost == null) && (degreeOfPollution != null
        ? degreeOfPollution.equals(that.degreeOfPollution)
        : that.degreeOfPollution == null);
  }
  ...
  public String toString() {
    return name + " " + breed + " " + character
        + " " + cost.toString() + " " + degreeOfPollution.toString();
  }
}
